...
class Order(models.Model):
    ...
    # ManyToManyField used because orders can contain many products. Products can be in many orders.
    products = models.ManyToManyField(Product)
    placed = models.DateField("Date", auto_now_add=True)  # captures current date
